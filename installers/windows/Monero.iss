...
; Haven GUI wallet exe and guide
Source: "bin\haven-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\haven-GUI-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\haven-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\haven-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\haven-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\haven-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\haven-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\haven-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
...
var s: String;
begin
  s := ExpandConstant('{app}\haven-wallet-gui.log');
  if Pos(' ', s) > 0 then begin
    // Quotes needed for filename with blanks
    s := '"' + s + '"';
  end;
...
Name: "{group}\GUI Wallet"; Filename: "{app}\haven-wallet-gui.exe"; Parameters: {code:WalletFlags}
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\haven-GUI-guide.pdf"; IconFilename: "{app}\haven-wallet-gui.exe"
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\haven-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
...
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\haven-wallet-gui.exe"; Parameters: {code:WalletFlags}; Tasks: desktopicon
