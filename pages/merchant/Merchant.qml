        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    font.bold: false
                    color: "white"
                    text: "<style type='text/css'>a {text-decoration: none; color: #404040; font-size: 12px;}</style>Currently selected address: " + addressLabel + " <a href='#'>(Change)</a>"
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Text {
                        ...
                        font.bold: false
                        color: "white"
                        text: qsTr("Amount to receive") + " (XHV)"
                    }
